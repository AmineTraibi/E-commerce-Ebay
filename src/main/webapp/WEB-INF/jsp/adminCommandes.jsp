...
function Calcul()
{
	...
	ChoixCd = document.getElementById("etat").value;
	document.getElementById("f").elements["etat"].value = 'ChoixCd' ;
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="admin" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">Dashboard</a>
                
                        </li>
                   
                        <li> <a class="has-arrow  " href="adminCommandes" aria-expanded="false"><i class="fa fa-shopping-bag"></i><span class="hide-menu">Commands</a>
                            
                        </li>
						<li> <a class="has-arrow  " href="adminAchats" aria-expanded="false"><i class="fa fa-cart-arrow-down"></i><span class="hide-menu">Achats</a>
                            
                        </li>
						<li> <a class="has-arrow  " href="adminPaiement" aria-expanded="false"><i class="fa fa-credit-card"></i><span class="hide-menu">Paiements</a>
                        </li>
                        
                        <li> <a class="has-arrow  " href="adminCourtier" aria-expanded="false"><i class="fa fa-drivers-license-o"></i><span class="hide-menu">Courtiers</a>
                        </li>
                         <li> <a class="has-arrow  " href="adminClient" aria-expanded="false"><i class="fa fa-group"></i><span class="hide-menu">Clients</a>
                        </li>
                    </ul>
                </nav>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Commandes</h3> </div>
                        ...
                        <div class="card bg-primary p-20">
                            <div class="media widget-ten">
                                <div class="media-left meida media-middle">
                                    <span><i class="ti-package f-s-40"></i></span>
                                </div>
                    ...
                    <div class="col-md-3">
                        <div class="card bg-danger p-20">
                            <div class="media widget-ten">
                                ...
                                <div class="media-body media-text-right">
                                    <h2 class="color-white"> ${ tailleAchat} </h2>
                                    <p class="m-b-0">Achats</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card bg-success p-20">
                            <div class="media widget-ten">
                                ...
                                <div class="media-body media-text-right">
                                    <h2 class="color-white"> ${ taillePaiement } </h2>
                                    <p class="m-b-0">Paiements</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card bg-danger p-20">
                            <div class="media widget-ten">
                                ...
                                <div class="media-body media-text-right">
                                <h2 class="color-white"> ${ tailleCourtier} </h2>
                                    <p class="m-b-0">Courtier</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <c:forEach var="l" items="${lc}"> 
                                            <tr>
                                               ...
                                               ${l.etat_cmd } 
                                                ...
                                                <td>${l.date }</td>
                                                <td>
                                                <a href="updatecommande?idc=${l.ref}&etat=${l.etat_cmd}"><button type="button" class="btn btn-success">Modifier</button></a>
                                           
                                                <a href="deletecommande?idc=${l.ref}"><button type="button" class="btn btn-danger" >Annuler</button></a>
                                                </td>
                                            </tr>
                                         </c:forEach>  
                                        </tbody>

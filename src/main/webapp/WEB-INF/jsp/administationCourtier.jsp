                                        ...
                                        <c:forEach var="l" items="${lc}"> 
                                            <tr>
                                               ...
                                               ${l.etat_cmd } 
                                                ...
                                                <td>${l.date }</td>
                                                <td>
                                               <a href="voircommande?idc=${l.ref}"><button type="button" class="btn btn-success" >Voir les details</button></a>
                                               <a href="modifiercommande?idc=${l.ref}"><button type="button" class="btn btn-danger" >Choisir commande</button></a>

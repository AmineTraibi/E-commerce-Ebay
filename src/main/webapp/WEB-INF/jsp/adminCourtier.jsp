        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Courtiers</h3> </div>
                ...
                <!-- Start Page Content -->
                 ...
                 <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Courtiers</h4>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <c:forEach var="l" items="${lc}"> 
                                            <tr>
                                                ...
                                                <td>${l.solde}</td>
                                               <td>
                                       	        <a href="updatecourtier?id=${l.login_crt}"><button type="button" class="btn btn-success">Voir Details</button></a>       
                                                <a href="deletecourtier?id=${l.login_crt}"><button type="button" class="btn btn-danger" >Supprimer</button></a>

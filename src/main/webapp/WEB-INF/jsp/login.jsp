		...
		<div class="container">
			<div class="col-md-6">
				 <div class="login-page">
					...
					<p>Create your account on Nomadic now! It's easy, just fill in your email address and follow the steps.REGISTER NOW!! For Free.</p>
					
				<p><i class="fa fa-check" style="font-size:15px"></i> See all your orders</p>
				<p><i class="fa fa-check" style="font-size:15px"></i> Fast re-order</p>
				<p><i class="fa fa-check" style="font-size:15px"></i> Fast Shipping</p>

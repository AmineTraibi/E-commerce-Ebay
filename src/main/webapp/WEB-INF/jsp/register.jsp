					  ...
					  <div class="menu">
						  <a class="toggleMenu" href="#"><img src="/resources/images/nav.png" alt="" /></a>
						    <ul class="nav" id="nav">
						    	...
						    	<li class="current"><a href="gologin">Sign up</a></li>
	     ...
	     <div class="container">
						<form class="" action="adduser" method="post"> 
								<div class="register-top-grid">
										...
										<div>
											<span>Address Personnel<label>*</label></span>
											<input type="text" name="adresse"> 
										</div>
										<div>
											<span>Type d'identifiant <label>*</label></span>
											<select name="typecin">
											<option selected="selected">Carte d'identite National</option>
											<option>Passeport</option>
											</select> 
										</div>
										<div>
											<span>Numéro d'identifiant <label>*</label></span>
											<input type="text" name="numcin"> 
										</div>
										<div class="clear"> </div>
								...
								<div class="clear"> </div>
								<div class="register-bottom-grid">
										<h3>INFORMATION COURTIER SEULEMENT</h3>
										<div>
											<span>NATIONALITE<label>*</label></span>
								...
								<input type="submit" name="Submit" class="amin" value="Valider">
						</form>
					</div>
		   </div>
	  </div>

                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <c:forEach var="l" items="${lc}"> 
                                            <tr>
                                                ...
                                                <td>${l.type_cin}</td>
                                                <td>
                        	                     <a href="updateclient?idc=${l.login}"><button type="button" class="btn btn-success">Voir Details</button></a>
                                               
                                                <a href="deleteclient?idc=${l.login}"><button type="button" class="btn btn-danger" >Supprimer</button></a>
                                                </td>
                                            </tr>
                                         </c:forEach>  
                                        </tbody>
